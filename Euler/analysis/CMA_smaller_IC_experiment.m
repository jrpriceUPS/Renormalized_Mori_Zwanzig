...
for j = 1:length(alpha_list)
    ...
    [c_find,laws_find,r_find] = renormalize(u_array,N_list,t_array,0,1);
    ...
    [c_t_find,laws_t_find,r_t_find] = renormalize(u_array,N_list,t_array,1,1);
    coefficients_t(j,:,:,:) = c_t_find;
    laws_t(j,:,:,:) = laws_t_find;
    r_t(j,:,:) = r_t_find;
