function [slopes,slopes2,turn_times,ens_max,ens_max_time,vort_max,vort_max_time] = renormalized_multiple_res_colorless(N_list,end_time,style,filetype)
%
%  [slopes,slopes2,turn_times,ens_max,ens_max_time,vort_max,vort_max_time] = renormalized_multiple_res_colorless(N_list,end_time,style,filetype)
%
...
%
%     style  =  a cell array of the plotting styles to employ
%
...
for i = 1:length(N_list)
    ...
    figure(1)
    hold on
    plot(log(t4),log(energy),style{i},'markersize',20)
    legend(leg_sw{:})
    ...
    figure(3)
    hold on
    plot(t4,ens,style{i},'markersize',20)
    legend(leg_ne{:})
    ...
    figure(4)
    hold on
    plot(t4(t4<=50),ens(t4<=50),style{i},'markersize',20)
    legend(leg_ne{:})
    title('Enstrophy','fontsize',16)
    xlabel('time','fontsize',16)
    ylabel('enstrophy','fontsize',16)
    ...
    figure(5)
    hold on
    plot(t4,vort2,style{i},'markersize',20)
    legend(leg_ne{:})
    ...
    figure(6)
    hold on
    plot(t4(t4<=50),vort2(t4<=50),style{i},'markersize',20)
    legend(leg_ne{:})
    title('Maximum of vorticity','fontsize',16)
    xlabel('time','fontsize',16)
    ylabel('maximal vorticity','fontsize',16)
    ...
    figure(7)
    hold on
    plot(t4(1:end-1),vort_int,style{i},'markersize',20)
    legend(leg_nw{:})
    ...
    figure(8)
    hold on
    plot(t4(t4(1:end-1)<=100),vort_int(t4(1:end-1)<=100),style{i},'markersize',20)
    legend(leg_nw{:})
    title('Integral of maximum of vorticity','fontsize',16)
    xlabel('time','fontsize',16)
    ylabel('Integral of max vorticity','fontsize',16)
