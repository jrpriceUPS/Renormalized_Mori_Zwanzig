...
snaps = 10:10:length(viable_snapshots);
...
figure(1)
hold off
plot(t_list(snaps),squeeze(coeffs(1,:,1,:)))
...
hold off
subplot(2,1,1)
plot(t_list(snaps),squeeze(coeffs(1,:,2,:)))
title('R1+R2 model, decaying','fontsize',16)
ylabel('R1','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
subplot(2,1,2)
plot(t_list(snaps),squeeze(coeffs(2,:,2,:)))
...
hold off
subplot(3,1,1)
plot(t_list(snaps),squeeze(coeffs(1,:,3,:)))
title('R1+R2+R3 model, decaying','fontsize',16)
ylabel('R1','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
subplot(3,1,2)
plot(t_list(snaps),squeeze(coeffs(2,:,3,:)))
ylabel('R2','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
subplot(3,1,3)
plot(t_list(snaps),squeeze(coeffs(3,:,3,:)))
...
hold off
subplot(2,2,1)
plot(t_list(snaps),squeeze(coeffs(1,:,4,:)))
title('R1+R2+R3+R4 model, decaying','fontsize',16)
ylabel('R1','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
subplot(2,2,2)
plot(t_list(snaps),squeeze(coeffs(2,:,4,:)))
ylabel('R2','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
subplot(2,2,3)
plot(t_list(snaps),squeeze(coeffs(3,:,4,:)))
ylabel('R3','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
subplot(2,2,4)
plot(t_list(snaps),squeeze(coeffs(4,:,4,:)))
...
figure(5)
hold off
plot(t_list(snaps),squeeze(coeffs_t(1,:,1,:)))
title('Only fit R1 model, decaying','fontsize',16)
ylabel('R1','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
saveas(gcf,'R1_c','png')
...
hold off
subplot(2,1,1)
plot(t_list(snaps),squeeze(coeffs_t(1,:,2,:)))
title('R1+R2 model, decaying','fontsize',16)
ylabel('R1','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
subplot(2,1,2)
plot(t_list(snaps),squeeze(coeffs_t(2,:,2,:)))
ylabel('R2','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
saveas(gcf,'R2_c','png')
...
hold off
subplot(3,1,1)
plot(t_list(snaps),squeeze(coeffs_t(1,:,3,:)))
title('R1+R2+R3 model, decaying','fontsize',16)
ylabel('R1','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
subplot(3,1,2)
plot(t_list(snaps),squeeze(coeffs_t(2,:,3,:)))
ylabel('R2','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
subplot(3,1,3)
plot(t_list(snaps),squeeze(coeffs_t(3,:,3,:)))
ylabel('R3','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
saveas(gcf,'R3_c','png')
...
hold off
subplot(2,2,1)
plot(t_list(snaps),squeeze(coeffs_t(1,:,4,:)))
title('R1+R2+R3+R4 model, decaying','fontsize',16)
ylabel('R1','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
subplot(2,2,2)
plot(t_list(snaps),squeeze(coeffs_t(2,:,4,:)))
ylabel('R2','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
subplot(2,2,3)
plot(t_list(snaps),squeeze(coeffs_t(3,:,4,:)))
ylabel('R3','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
subplot(2,2,4)
plot(t_list(snaps),squeeze(coeffs_t(4,:,4,:)))
ylabel('R4','fontsize',16)
xlabel('Edge of window T ([0,T])','fontsize',16)
saveas(gcf,'R4_c','png')
