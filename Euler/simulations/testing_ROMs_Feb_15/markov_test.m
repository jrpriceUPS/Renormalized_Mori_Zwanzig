...
[t_full,u_raw_full] = ode45(@(t,u) full_euler(u,k_full,N_full,t),[0,end_time],u1(:),options);
[t_markov,u_raw_markov] = ode45(@(t,u) markov_euler(u,k_markov,N_markov),[0,end_time],u2(:),options);
