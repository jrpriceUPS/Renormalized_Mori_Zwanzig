...
end_time = 6.54; % point of instability
...
plot(t_t2model,energy_t2model,'c','linewidth',2)
axis([0,8,0,0.5])
legend('Full model, N = 8','Markov model, N = 4','t-model, N = 4','t^2-model, N = 4','location','t^3-model, N = 4','location','southwest')
...
plot(t_t2model,w_t2model,'c','linewidth',2)
legend('Full model, N = 8','Markov model, N = 4','t-model, N = 4','t^2-model, N = 4','location','t^3-model, N = 4','location','southwest')
