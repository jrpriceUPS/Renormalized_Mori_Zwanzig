...
for i = 1:length(N_list)
    ...
    if exist(sprintf('../multiple_renormalized_models_Mar_19/u_array4_%i.mat',N),'file') == 2
        
        load(sprintf('../multiple_renormalized_models_Mar_19/u_array4_%i.mat',N))
        load(sprintf('../multiple_renormalized_models_Mar_19/t4_%i',N))
        ...
        save(sprintf('../multiple_renormalized_models_Mar_19/t4_%i',N),'t4');
        save(sprintf('../multiple_renormalized_models_Mar_19/u_array4_%i.mat',N),'u_array4');
    ...
    if exist(sprintf('u_array4_%i_nofit.mat',N),'file') == 2
        
        load(sprintf('u_array4_%i_nofit.mat',N))
        load(sprintf('t4_%i_nofit',N))
        ...
        save(sprintf('t4_%i_nofit',N),'t4_nofit');
        save(sprintf('u_array4_%i_nofit.mat',N),'u_array4_nofit');
