function du_dt = t4model_euler(u,k,N,time,coeff)
%
% The ODE for the t^4-model term of 3D Euler's equations:
%
% du_k/dt = R^0(u) + Sum_{i=1}^4 R^i(u)
%
%
%%%%%%%%%
%INPUTS:%
...
du_dt = t4model_RHS(u_full,a,b,k,a_tilde,N,time,coeff);
