function [t2,Ahat,Atilde,Bhat,Btilde] = t2model_term(u_full,t0hat,t0tilde,t1tilde,a,b,k,a_tilde)
%
...
[~,Ahat,Atilde] = Dk(u_full,t0hat,a,b,k,a_tilde);
[B,Bhat,Btilde] = Ck(t0tilde,t0tilde,a,b,k,a_tilde);

[first_term,~,~] = Dk(u_full,t1tilde-Atilde,a,b,k,a_tilde);
