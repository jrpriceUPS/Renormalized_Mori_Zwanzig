function renormalization_params = multi_renormalized_complete_3rd_order_energy_dispers(simulation_params,renormalization_params)
...
%compute t^2-model term
[nonlin2,uk,uu,A,A_star,B,B_star,C,C_star,D_star] = t2model_term_complete(u_full,nonlin0_nondispers,uu_star,alpha,F_modes,G_modes,k,epsilon);
