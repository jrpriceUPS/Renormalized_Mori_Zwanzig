function nonlin=multi_renormalized_complete_3rd_order(u,t,simulation_params)
%
...
if coeffs(2) == 0
    ...
    [nonlin2_nondispers,uk,uu,A,A_star,B,B_star,C,C_star,D_star] = t2model_term_complete(u_full,nonlin0_nondispers,uu_star,alpha,F_modes,G_modes,k,epsilon);
end
...
if coeffs(3) == 0
    ...
    nonlin3_nondispers = t3model_term_complete(alpha,F_modes,k,epsilon,u_full,uu,uu_star,uk,A,A_star,B,B_star,C,C_star,D_star);
end
...
if coeffs(2) == 0
    ...
    [nonlin2_dispers,uk,uu,A,A_star,B,B_star,C,C_star,D_star] = t2model_term_complete(u_full,nonlin0_nondispers,uu_star,alpha,F_modes,G_modes,k,epsilon);
end
...
if coeffs(3) == 0
    ...
    nonlin3_dispers = t3model_term_complete(alpha,F_modes,k,epsilon,u_full,uu,uu_star,uk,A,A_star,B,B_star,C,C_star,D_star);
end
