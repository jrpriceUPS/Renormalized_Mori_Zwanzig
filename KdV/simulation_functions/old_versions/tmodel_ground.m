function [u_rec,t_rec]=tmodel_ground(M,epsilon,endtime,dt,rec,tol)
%
%[u_rec,t_rec]=tmodel_ground(M,epsilon,endtime,dt,tol)
%
%Computes the t-model solution for M modes based on a "full" model of 2M
...
%
%
%Example Input: [u_rec,t_rec]=tmodel_ground(64,0.1,1,1e-4,1000,1e-10);
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Outputs:
