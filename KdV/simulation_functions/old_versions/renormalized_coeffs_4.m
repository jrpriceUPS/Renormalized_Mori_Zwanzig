function [t_list,u_list]=renormalized_coeffs_4(N,epsilon,alpha,endtime,dt,coeffs,howoften,tol,blowup)
%
%[t_list,u_list]=renormalized_coeffs_4(N,epsilon,alpha,endtime,dt,coeffs,howoften,tol)
%
%Computes the 3rd order renormalized ROM solution for N modes based with
%renormalization coefficents coeffs on a "full" model of 2N modes of KdV
%equation with a pseudo-fourth order implicit-explicit Runge-Kutta solver.
%
...
%      dt  =  timestep
%
%  coeffs  =  renormalization coefficients
%
...
%
%
%Example Input: [t_list,u_list]=renormalized_coeffs_4(16,0,2,1,1e-4,[0.1;0.006;0.0004],100,1e-10)
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Outputs:
