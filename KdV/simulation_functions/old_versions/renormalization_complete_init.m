function [simulation_params,renormalization_params] = renormalization_complete_init(model,simulation_params)
%
%[simulation_params,renormalization_params] = renormalization_complete_init(model,simulation_params)
%
%Takes initial model and simulation_params structures and initializes them
%for a complete renormalization simulation.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Inputs:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%define the ordinates in real space so there are 2N positive modes for full
%model
...
simulation_params.M = 3*N_list(1);
...
renormalization_params.M = 2*N_list(1);
...
renormalization_params.energy{1} = @(a,b) renormalized_complete_3rd_order_energy(a,b);
renormalization_params.evolution = @(x,y,z) renormalized_complete_3rd_order(x,y,z);
renormalization_params.renorm_count = 0;
renormalization_params.total_renorm = 1;
renormalization_params.F_modes_new = F_modes{1};
renormalization_params.G_modes_new = G_modes{1};
renormalization_params.k_new = k{1};