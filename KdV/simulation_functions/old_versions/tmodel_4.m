function [t_list,u_list]=tmodel_4(N,epsilon,alpha,endtime,dt,howoften,tol)
%
%[t_list,u_list]=tmodel_4(N,epsilon,endtime,dt,howoften,tol)
%
...
B=@(x,t) nonlinear_red(x,alpha,2*N+1,N,F_modes,t);
