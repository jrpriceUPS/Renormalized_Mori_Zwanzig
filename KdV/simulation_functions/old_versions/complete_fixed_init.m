function simulation_params = complete_fixed_init(simulation_params)
%
...
if ~isfield(simulation_params,'coeffs')
    ...
    if simulation_params.order == 4
        ...
        simulation_params.coeffs(2) = -1.212317206140178*epsilon^-3.691035548147793*N^-5.735647633869574;
        simulation_params.coeffs(4) = 0.350302790566717*epsilon^-7.388110167590722*N^-11.471931044430516;
    elseif simulation_params.order == 2
        simulation_params.coeffs = zeros(2,1);
        simulation_params.coeffs(2) = -0.736484322584620*epsilon^-3.768112452272889*N^-5.808123274868915;
    end
