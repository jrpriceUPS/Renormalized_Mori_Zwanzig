function [u_complete,t,energyvector1,energyvector2]=fullsolution_2(M,N,epsilon,endtime,dt,fig,howoften,tol)
%
%Example input: [u_complete,t,energyvector1,energyvector2]=fullsolution_2(M,N,epsilon,endtime,dt,fig,howoften,tol)
%
%Computes the "full" solution of KdV equation with a second order
...
%Records the energy contained in the reduced modes [-N,N].
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Inputs:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
%       N  =  number of positive Fourier modes in reduced basis
%
...
%
%
%Example Input: [u,t,energy]=fullsolution_2(64,8,0.1,1,1e-4,1,100,1e-4);
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Outputs:
...
%
%energyvector1  =  A vector of the total energy at each timestep (should be
%                  constant)
%
%energyvector2  =  A vector of the energy at each timestep contained in
%                  the reduced modes [-N:N-1]
...
energyvector1=zeros(1,nsteps+1);

%initialize reduced modes energy vector
energyvector2=zeros(1,nsteps+1);

%fill in initial values for each
energyvector1(1)=sum(abs(u_complete/(2*M)).^2);
energyvector2(1)=sum(abs(u_complete(Findex)/(2*M)).^2);
...
for i=1:4
    ...
    energyvector1(i+1)=sum(abs(u_complete/(2*M)).^2);
    energyvector2(i+1)=sum(abs(u_complete(Findex)/(2*M)).^2);
end
...
for i=5:nsteps
    ...
    if abs(energyvector1(i+1)-energyvector1(1))/abs(energyvector1(1))>tol
