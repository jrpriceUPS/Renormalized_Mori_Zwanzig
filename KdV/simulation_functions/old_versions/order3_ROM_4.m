function [t_list,u_list]=order3_ROM_4(N,epsilon,alpha,endtime,dt,howoften,tol)
%
%[t_list,u_list]=order3_ROM_4(N,epsilon,alpha,endtime,dt,howoften,tol)
%
...
%
%
%Example Input: [t_list,u_list]=order3_ROM_4(64,0.1,6,1,1e-4,100,1e-10)
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Outputs:
...
B=@(x,t) nonlinear_3rd_order(x,2*N+1,N,epsilon,alpha,F_modes,G_modes,k,t);
