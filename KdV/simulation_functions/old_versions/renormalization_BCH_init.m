function [simulation_params,renormalization_params] = renormalization_BCH_init(model,simulation_params)
%
%[simulation_params,renormalization_params] = renormalization_BCH_init(model,simulation_params)
%
%Takes initial model and simulation_params structures and initializes them
%for a BCH renormalization simulation.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Inputs:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
renormalization_params.energy{1} = @(a,b) renormalized_3rd_order_energy(a,b);
renormalization_params.evolution = @(x,y,z) renormalized_3rd_order(x,y,z);
