function [simulation_params,renormalization_params] = multi_renormalization_BCH_init(model,simulation_params)
%
...
%for a BCH renormalization simulation with two renormalization steps.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Inputs:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
renormalization_params.energy{1} = @(a,b) multi_renormalized_3rd_order_energy_nondispers(a,b);
renormalization_params.energy{2} = @(a,b) multi_renormalized_3rd_order_energy_dispers(a,b);
renormalization_params.evolution = @(x,y,z) multi_renormalized_3rd_order(x,y,z);
