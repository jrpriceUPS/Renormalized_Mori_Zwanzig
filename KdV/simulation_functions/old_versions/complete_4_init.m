function simulation_params = complete_4_init(simulation_params)
%
%[simulation_params] = complete_4_init(simulation_params)
%
%Takes simulation_params structures and initializes them for a complete 
%memory approximation with provided coefficients simulation and 
%t-dependence.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Inputs:
