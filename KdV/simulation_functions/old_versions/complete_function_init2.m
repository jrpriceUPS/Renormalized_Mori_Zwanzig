function simulation_params = complete_function_init2(simulation_params)
%
%[simulation_params] = complete_fixed_init(simulation_params)
%
%Takes simulation_params structures and initializes them
%for a complete memory approximation up to t^2-model with known effective 
...
simulation_params.coeffs = renormalized_ROM_coeffs2(simulation_params.epsilon,simulation_params.N);
