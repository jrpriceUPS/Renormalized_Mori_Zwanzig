function [nonlin0,u_full] = markov_term_BKdV(u,M,N)
%
%Computes the Markov term of Burgers-KdV for a given state vector and size 
%of full model
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
nonlin0 = convolution_sum_BKdV(u_full,u_full);