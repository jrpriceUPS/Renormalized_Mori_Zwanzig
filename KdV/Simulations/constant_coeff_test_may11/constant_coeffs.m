function coeffs_list = constant_coeffs(t_list,energy_flow_list,nonlin0_energy_flow,nonlin1_energy_flow,nonlin2_energy_flow,nonlin3_energy_flow,nonlin4_energy_flow,N_list,window_width,spacing,disp_plots)
%
%Calculates optimal 4th order ROM coefficients for fitting the net energy
%in different sets of resolved modes using constant (Burgers-style)
%coefficients
%
%%%%%%%%%
%Inputs:%
...
nonlin4_energy_flow = t_array.^4.*nonlin4_energy_flow;
