%finds coefficients for t2 and t4 assuming t1 and t3 are zero, then finds
%the scaling laws
...
for j = 1:length(epsilon)
    ...
    coeffs_list = t2_and_t4_coeffs(t_list,energy_flow_list,nonlin0_energy_flow,nonlin1_energy_flow,nonlin2_energy_flow,nonlin3_energy_flow,nonlin4_energy_flow,N_list,0,10,0);
